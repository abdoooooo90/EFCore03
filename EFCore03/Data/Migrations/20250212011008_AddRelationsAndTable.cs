...
{
    /// <inheritdoc />
    public partial class AddRelationsAndTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "varchar(11)", maxLength: 11, nullable: false),
                    Bouns = table.Column<int>(type: "int", nullable: true),
                    Salary = table.Column<int>(type: "int", nullable: false, defaultValue: 3000),
                    Address = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    HourRate = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false, defaultValue: 20.0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FName = table.Column<string>(type: "varchar(11)", maxLength: 11, nullable: false),
                    LName = table.Column<string>(type: "varchar(11)", maxLength: 11, nullable: false),
